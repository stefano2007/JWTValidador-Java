...
class JWTValidadorApplicationTests {
	...
	void Valid_ReturnsOkResponse() {
		// Arrange & Act
		ResponseEntity<String> response = validadorController.Get(JWTFixture.JWT_VALIDO_CASO1);
	...
	void InvalidJwt_ReturnsBadRequestResponse() {
		// Arrange & Act
		ResponseEntity<String> response = validadorController.Get(JWTFixture.JWT_INVALIDO_CASO2);
	...
	void InvalidName_ReturnsBadRequestResponse() {
		// Arrange & Act
		ResponseEntity<String> response = validadorController.Get(JWTFixture.JWT_INVALIDO_CASO3);
		...
		Assertions.assertEquals("The Name cannot have a number character", exceptionMessage);
	...
	void InvalidStruture_ReturnsBadRequestResponse() {
		// Arrange & Act
		ResponseEntity<String> response = validadorController.Get(JWTFixture.JWT_INVALIDO_CASO4);
